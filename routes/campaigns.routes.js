...
router.patch("/:campaignId/registrations/:registrationId", updateRegistrationHandler)
router.delete("/:campaignId/registrations/:registrationId", deleteRegistrationHandler)
...
router.patch("/:campaignId/waste-collections/:collectionId", updateWasteCollectionHandler)
router.delete("/:campaignId/waste-collections/:collectionId", deleteWasteCollectionHandler)

router.get("/:id", getCampaignById)
router.patch("/:id", requireRole("admin", "organizer"), updateCampaignHandler)
